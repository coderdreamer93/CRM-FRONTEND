...
export default function LeadsComponent() {
  ...
  // ✅ Fetch leads from API with authentication
  ...
  // ✅ Handle lead submission with authentication
  ...
  return (
    <>
      <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '16px' }}>
        <Button variant="contained" color="primary" className='text-white' onClick={() => setOpen(true)}>
          Add Lead
        </Button>
      </div>
